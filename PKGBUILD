...
build() {
  ...
  nativefier \
    ...
    --width "800px" \
    --height "600px" \
    --user-agent "Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/17.5 Chrome/126.0.6478.122 Safari/605.1.15" \
